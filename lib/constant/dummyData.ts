...
export const products: Product[] = [
  {
    id: 1,
    sellerId: 101,
    name: "Industrial Raw Cotton Fabric Bolt",
    image: "https://images.unsplash.com/photo-1584100936595-c0654b55a2e2",
    rating: 4.8,
    reviews: "Excellent quality fabric, suitable for bulk garment production.",
    sale: true,
    reviewsCount: 24,
    oldPrice: 1500.0,
    description:
      "100% natural unbleached cotton fabric bolt designed for high-volume textile manufacturing.",
...
export const Allproducts: Product[] = [
  {
    ...
    description:
      "Fresh organic carrots suitable for wholesale and bulk export orders.",
    ...
    seller: {
      ...
      logo: "/suppliers/greenfield.jpg",
      coverPhoto: "/suppliers/greenfield-cover.jpg",
      ...
      companyName: "GreenField Agro Traders",
      contactName: "GreenField Sales Team",
    },
